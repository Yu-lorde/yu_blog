  ...
  try {
    ...
    if (res.code != 0 || !res.result) {
      ElNotification({
        offset: 60,
        title: "提示",
        message: h("div", { style: "color: #f56c6c; font-weight: 600;" }, res?.message || "文章加载失败"),
      });
      return;
    }
    ...
    const userId = userInfo && typeof userInfo === "object" ? userInfo.id : undefined;
    ...
    ElNotification({
      offset: 60,
      title: "提示",
      message: h("div", { style: "color: #f56c6c; font-weight: 600;" }, "文章加载失败，请确认后端已启动"),
    });
  }
};
